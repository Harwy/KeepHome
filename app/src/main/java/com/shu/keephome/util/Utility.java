...
//    }
    ...
    /**
     * 返回的JSON数据解析成DataProductList实体类
     */
    public static DataProductList handleDataProductListResponse(String response){
        try {
            return new Gson().fromJson(response,DataProductList.class);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
